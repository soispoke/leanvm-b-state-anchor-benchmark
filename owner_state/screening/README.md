...
- A one-MUL full-adder carry reduces multiplications but loses constant-folding opportunities. For a 64-byte SHA input, its hash logic grows from 197,090 to 202,826 gates before compiler optimization.
