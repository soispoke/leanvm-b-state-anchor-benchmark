...
| --- | ---: | ---: | ---: | ---: |
| Direct state root | 0.455 | 0.656 | 8.825 | 9.936 |
| RLP block hash | 0.834 | 0.790 | 9.311 | 10.936 |
| SSZ summary* | 0.833 | 0.792 | 9.874 | 11.499 |
...
| --- | ---: | ---: | ---: |
| Direct state root | 834,752 | 171.7 ms | 37.79 GiB |
| RLP block hash | 835,712 | 326.8 ms | 38.23 GiB |
| SSZ summary* | 836,384 | 345.3 ms | 40.19 GiB |

All 54 proofs passed their public-input and serialized-proof tamper checks. The six saved proofs also verified in fresh processes containing no witness files. All 85 altered-witness checks and 47 native/compiler/measurement tests passed. [Raw evidence and source hashes](evidence.json) preserve these checks.
...
python -m owner_state.run verify --run owner_state/results/collect-20260911T071527362410Z
```
