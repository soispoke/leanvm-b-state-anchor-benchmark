...
`orchestrate.py` records the setup, full schedule, source snapshots, preflight readings, commands and outcomes in this directory. It prevents accidental reuse of an experiment directory.
